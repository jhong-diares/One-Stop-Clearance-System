...
Namespace one_stop_clearance_system
    Partial Public Class GuidanceControl
        ...
        Protected Overridable Sub OnCommandsChanged(ByVal oldValue As mod_commands, ByVal newValue As mod_commands)
            If newValue IsNot Nothing Then
                cancelButton.Command = newValue.GuidanceCommands.Cancel
            Else
        ...
        Private Sub InitializeComponent()
            ...
            'ColumnHeader4
            '
            Me.ColumnHeader4.Text = "Uncollected Requirements"
