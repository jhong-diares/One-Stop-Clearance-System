...
Namespace one_stop_clearance_system
    Partial Public Class LibraryControl
        ...
        Protected Overridable Sub OnCommandsChanged(ByVal oldValue As mod_commands, ByVal newValue As mod_commands)
            If newValue IsNot Nothing Then
                cancelButton.Command = newValue.LibraryCommands.Cancel
            Else
        ...
        Private Sub InitializeComponent()
            ...
            'ColumnHeader4
            '
            Me.ColumnHeader4.Text = "Unreturned Book(s)"
            Me.ColumnHeader4.TextAlign = System.Windows.Forms.HorizontalAlignment.Center
            Me.ColumnHeader4.Width = 300
            '
            'ColumnHeader1
            '
            Me.ColumnHeader1.Text = "Remaining Penalty"
